...
Authorization: NOT_AUTHORIZED (requires post–IC-02 ADR)
Predecessor:  IC-02 RedDirt Read Integration (ADR-104) COMPLETE at ship
...
`IC_03_STATUS` remains **`NOT_AUTHORIZED`** until a separate Kelly ADR after IC-02 ship evidence is accepted.
