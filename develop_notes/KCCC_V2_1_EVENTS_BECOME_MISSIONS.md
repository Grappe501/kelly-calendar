...
**Calendar Completion:** CC-01/CC-02/CC-03 do not create or mutate Missions. CC-02 may *report* Mission-boundary anomalies (orphaned/multi-Mission) but never repairs Mission data. CC-03 hardens Event time semantics and may change Mission *presentation* of schedule times without advancing Mission lifecycle.
