export const CURRENT_STEP_ID = "KCCC-CAL-EXP-FOUNDATION";
...
export const CALENDAR_EXPERIENCE_PASS = "version-1-complete";
...
export const NEXT_ENGINEERING_DELIVERABLE = "KCCC-CAL-EXP-FOUNDATION";
