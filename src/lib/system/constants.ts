...
export const CALENDAR_EXPERIENCE_PASS = "3-month-view";
export const CALENDAR_EXPERIENCE_REVIEW_STATUS = "READY";
export const NEXT_ARCHITECTURAL_DELIVERABLE = "KCCC_PHASE3_TRUST_MODEL";
export const NEXT_ENGINEERING_DELIVERABLE = "KCCC-CAL-EXP-REVIEW";
