export const CURRENT_STEP_ID = "KCCC-ENG-AUDIT-V1";
...
export const ENGINEERING_AUDIT_STATUS = "OPEN";
export const HARDENING_PASS_STATUS = "BLOCKED";
export const CALENDAR_FOUNDATION_STATUS = "PLANNED_AFTER_HARDENING";
export const NEXT_ARCHITECTURAL_DELIVERABLE = "KCCC_PHASE3_TRUST_MODEL";
export const NEXT_ENGINEERING_DELIVERABLE = "KCCC-ENG-AUDIT-V1";
