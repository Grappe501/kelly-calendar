...
import { acknowledgeIssue } from "@/server/services/mission-logistics-service";
...
export async function POST(request: Request, context: Ctx) {
  ...
  return withAuthenticatedMutation(
    request,
    "/api/missions/[missionId]/logistics/acknowledgements",
    async ({ actor }) => {
      ...
      const result = await acknowledgeIssue({ missionId, actor, body });
