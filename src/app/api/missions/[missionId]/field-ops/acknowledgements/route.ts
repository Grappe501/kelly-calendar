...
import { acknowledgeFieldOpsIssue } from "@/server/services/mission-field-ops-service";
...
export async function POST(request: Request, context: Ctx) {
  ...
  return withAuthenticatedMutation(
    request,
    "/api/missions/[missionId]/field-ops/acknowledgements",
    async ({ actor }) => {
      ...
      const result = await acknowledgeFieldOpsIssue({ missionId, actor, body });
