...
import { confirmFieldItem } from "@/server/services/mission-field-ops-service";
...
export async function POST(request: Request, context: Ctx) {
  ...
  return withAuthenticatedMutation(
    request,
    "/api/missions/[missionId]/field-ops/confirmations",
    async ({ actor }) => {
      ...
      return { model: await confirmFieldItem({ missionId, actor, body }) };
    },
  );
}
