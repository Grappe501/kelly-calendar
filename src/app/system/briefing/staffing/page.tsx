...
export default async function TodaysStaffingRedirectPage() {
  await requireSystemAdminPage("/system/briefing/staffing");
  const tz = getPublicAppConfig().campaignTimezone;
  redirect(`/system/briefing/${campaignDateKey(new Date(), tz)}/staffing`);
}
