...
export default async function TodaysLogisticsRedirectPage() {
  await requireSystemAdminPage("/system/briefing/logistics");
  const tz = getPublicAppConfig().campaignTimezone;
  redirect(`/system/briefing/${campaignDateKey(new Date(), tz)}/logistics`);
}
