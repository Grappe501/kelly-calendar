...
export default async function TodaysFieldOpsRedirectPage() {
  await requireSystemAdminPage("/system/briefing/field-ops");
  const tz = getPublicAppConfig().campaignTimezone;
  redirect(`/system/briefing/${campaignDateKey(new Date(), tz)}/field-ops`);
}
