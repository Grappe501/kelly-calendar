...
export default async function TodaysIncidentsRedirectPage() {
  await requireSystemAdminPage("/system/briefing/incidents");
  const tz = getPublicAppConfig().campaignTimezone;
  redirect(`/system/briefing/${campaignDateKey(new Date(), tz)}/incidents`);
}
