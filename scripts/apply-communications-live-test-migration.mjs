/**
 * Apply D26 live-test SQL when migrate history diverged.
...
const migrationName = "20260721140000_v21_communications_controlled_live_test";
...
console.log(`Live-test SQL applied (${statements.length} statements).`);
...
if (existing.length === 0) {
  await p.$executeRawUnsafe(`
    ...
    VALUES
      (gen_random_uuid()::text, 'manual-d26-live-test', NOW(), '${migrationName}', NULL, NULL, NOW(), 1)
  `);
