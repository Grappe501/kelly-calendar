/**
 * V2.1 Communications Composition + prior mission unit validation (D1–D23).
 */
...
const files = [
  ...
  "tests/unit/missions/v21-staffing.test.ts",
  "tests/unit/missions/v21-communications.test.ts",
  "tests/unit/missions/v21-communications-dispatch.test.ts",
  "tests/unit/missions/v21-communications-provider.test.ts",
  "tests/unit/missions/v21-communications-composition.test.ts",
];
