  ...
  // ── August 17–20 NWA Immersion ────────────────────────────────────
  {
    ...
    privateNotes: notes(
      ...
      [
        ...
        "Related lodging offer: Shela Norman (Bella Vista Airbnb) — see planning draft benton-aug-trip.",
      ].join("\n"),
    ),
  },
...
const PLANNING_DRAFTS = [
  {
    ...
    payload: {
      ...
      timing: { timezone: "America/Chicago", allDay: false, note: "August 2026 — dates TBD" },
      location: {
        state: "Arkansas",
        county: "Benton",
      ...
      privateMissionNotes: [
        "NOT a dated calendar Event until itinerary locks.",
        "Lodging offered: Shela Norman (Bella Vista Airbnb) — accepted in principle pending dates.",
        "FOIA tax-rolls discussion: determine if campaign follows up or Scott handles independently.",
        "Contact details in operator CRM only.",
      ].join("\n"),
    },
  },
  {
