  ...
  // ── August 17–20 NWA Immersion ────────────────────────────────────
  {
    ...
    privateNotes: notes(
      ...
      [
        ...
        "STRUCTURE: Daytime immersion + evening JP-district community gatherings (hosts/districts TBD).",
        "Mon travel in · Thu evening return Rose Bud.",
        "REQUIRED nightly intelligence report; end: Benton County Summary + 90-day plan.",
        "See events:ingest:benton-immersion-week for daily + JP evening children.",
        "LODGING: Shela Norman (Bella Vista) Airbnb OFFERED — draft_obs_benton_aug_trip_2026.",
      ].join("\n"),
    ),
  },
