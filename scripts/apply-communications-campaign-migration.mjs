/**
 * Apply D25 campaign SQL when migrate history diverged.
...
const migrationName = "20260721120000_v21_communications_campaign_execution";
...
console.log(`Campaign SQL applied (${statements.length} statements).`);
...
if (existing.length === 0) {
  await p.$executeRawUnsafe(`
    ...
    VALUES
      (gen_random_uuid()::text, 'manual-d25-campaign', NOW(), '${migrationName}', NULL, NULL, NOW(), 1)
  `);
